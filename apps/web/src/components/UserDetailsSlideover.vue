...
import UserEditSlideover from "./UserEditSlideover.vue";
  ...
  <USlideover>
    ...
    <template #body>
      <div v-if="user" class="space-y-6">
        ...
        <div class="space-y-2">
          <h3
            class="text-sm font-semibold text-neutral-400 dark:text-neutral-500"
          >
            Basic Info
          </h3>
    ...
    <template #footer>
      <UButton type="button" @click="userEditSlideover.open({ user })">
        Edit
      </UButton>
    </template>
  </USlideover>
